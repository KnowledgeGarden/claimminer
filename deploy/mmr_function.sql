...
CREATE OR REPLACE FUNCTION mmr(query_embedding vector, query_fragment integer, embedding_table varchar, scales varchar[], k integer, lam float, qlimit integer) RETURNS SETOF id_score_type AS $$
    import numpy as np
    pos_by_id = {}
